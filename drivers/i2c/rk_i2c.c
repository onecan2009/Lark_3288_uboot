...
static int rk_i2c_send_start_bit(struct rk_i2c *i2c)
{
	...
	i2c_writel(I2C_IPD_ALL_CLEAN, i2c->regs + I2C_IPD);     //clean interrupte pending status

	i2c_writel(I2C_CON_EN | I2C_CON_START, i2c->regs + I2C_CON);    //i2c con register enable and start 
	i2c_writel(I2C_STARTIEN, i2c->regs + I2C_IEN);                  //i2c interrupte enbale
