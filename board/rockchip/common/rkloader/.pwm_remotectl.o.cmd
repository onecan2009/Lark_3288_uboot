cmd_board/rockchip/common/rkloader/pwm_remotectl.o := /home/ubuntu/rk3288-sdk/uboot_test/../prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/bin/arm-eabi-gcc -Wp,-MD,board/rockchip/common/rkloader/.pwm_remotectl.o.d  -nostdinc -isystem /home/ubuntu/rk3288-sdk/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/bin/../lib/gcc/arm-eabi/4.7/include -Iinclude  -I/home/ubuntu/rk3288-sdk/uboot_test/arch/arm/include -include /home/ubuntu/rk3288-sdk/uboot_test/include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x00000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -march=armv7-a -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(pwm_remotectl)"  -D"KBUILD_MODNAME=KBUILD_STR(pwm_remotectl)" -c -o board/rockchip/common/rkloader/pwm_remotectl.o board/rockchip/common/rkloader/pwm_remotectl.c

source_board/rockchip/common/rkloader/pwm_remotectl.o := board/rockchip/common/rkloader/pwm_remotectl.c

deps_board/rockchip/common/rkloader/pwm_remotectl.o := \
  ...
  include/malloc.h \
  include/fdtdec.h \
    $(wildcard include/config/rockchip/arch64.h) \
  include/libfdt.h \
...
board/rockchip/common/rkloader/pwm_remotectl.o: $(deps_board/rockchip/common/rkloader/pwm_remotectl.o)
